...
import { TypedDispatchHook, TypedSelectorHook } from "@iavofficial/frontend-framework/reExportedTypes";
...
export const useTypedDispatch: TypedDispatchHook<typeof store.getState> = useDispatch;

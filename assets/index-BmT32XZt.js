...
BasicLoginView.contextType = AuthContext;`})]}),T=()=>e.jsxs(s,{children:[e.jsx(i,{children:"UILayer: Navigation and Content Area Elements"}),e.jsx(n,{children:"Introduction"}),e.jsx(t,{children:"The UILayer provides the UI components and some basic logic for the application. The UILayer has the following properties, some of them are explained later on:"}),e.jsx(o,{title:"Interface UILayer",language:"typescript",children:`export interface Props {
...
}`}),e.jsxs(t,{children:["If the user wants to add their own elements in the header, they can either use their own React elements or fall back on the",e.jsx("strong",{children:"HeaderMenuElement"})," for a menu or",e.jsx("strong",{children:"HeaderPanelElement"})," for an overlay panel provided by the IAV Frontend Framework."]}),e.jsx(a,{children:"AuthOptions: How to configure the authentication view?"}),e.jsx(t,{children:"These options (property of the UILayer component) allow you to configure the authentication view."}),e.jsx(o,{title:"Interface AuthOptions",language:"typescript",children:`interface AuthOptions {
...
};`}),e.jsx(t,{children:"The framework also exports templates. These are just predefined arrays of styles. These are the following:"}),e.jsx(d,{bulletType:"bullet",items:["DEFAULT: This template should be used for simple content areas (for example it sets a colored gap).","CONTENT_CELLS: This template should be used if you want to use the ContentCell component."]}),e.jsx(o,{title:"First Example",language:"typescript",children:`<ContentStyle
...
}`}),e.jsx(a,{children:"Color options of the navigation bar (including the navigation tabs)"}),e.jsx(t,{children:"Using these options you can define the colors of the main view's navigation bar."}),e.jsx(o,{title:"Interface NavbarColorType",language:"typescript",children:`export interface NavbarColorOptions {
    backgroundColor?: string;

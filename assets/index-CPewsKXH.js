...
}`}),e.jsxs(t,{children:["You can find more information about I18next",e.jsx(c,{to:"https://react.i18next.com/",label:"here",target:"_blank"}),"."]}),e.jsx(a,{children:"GlobalDataLayerLanguageOptions"}),e.jsx(o,{language:"typescript",children:`interface GlobalDataLayerLanguageOptions {
...
BasicLoginView.contextType = AuthContext;`})]}),T=()=>e.jsxs(r,{children:[e.jsx(i,{children:"UILayer: Navigation and Content Area Elements"}),e.jsx(n,{children:"Introduction"}),e.jsx(t,{children:"The UILayer provides the UI components and some basic logic for the application. The UILayer has the following properties, some of them are explained later on:"}),e.jsx(o,{title:"PageInterface PageUiLayer",language:"typescript",children:`export interface Props {

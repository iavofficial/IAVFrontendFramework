...
BasicLoginView.contextType = AuthContext;`})]}),S=()=>e.jsxs(r,{children:[e.jsx(i,{children:"UILayer: Navigation and Content Area Elements"}),e.jsx(n,{children:"Introduction"}),e.jsx(t,{children:"The UILayer provides the UI components and some basic logic for the application. The UILayer has the following properties, some of them are explained later on:"}),e.jsx(o,{title:"PageInterface PageUiLayer",language:"typescript",children:`export interface Props {
    ...
    hideNavbar?: boolean; // Option to hide the navbar. This could be useful if you develop a single screen application. 
    customHeader?: React.ComponentType<any> // Optional property to set an own custom header. Default will be used if not set.

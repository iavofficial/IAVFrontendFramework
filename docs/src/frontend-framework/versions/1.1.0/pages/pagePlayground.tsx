...
const PagePlayground: React.FC = () => {
  return (
    <Page>
      <SubTitle>Cloning the Repository</SubTitle>
      <Text>
        If you want to play with the framework and the contained example
        project, you have to clone the framework&#39;s Git repository first.
      </Text>
      ...
      <Text>
        ...
        This is where the example project comes into use. The example project
        uses the locally built framework as a file dependency in order to
        visualize the consequences of framework changes.
      </Text>
      ...
      <Text>
        ...
        inside the root folder of the <strong>repository</strong>. This will
        setup the environment and start the development server at port 3000.
      </Text>

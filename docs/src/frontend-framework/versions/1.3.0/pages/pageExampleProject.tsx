...
const PageExampleProject: React.FC = () => {
  return (
    <Page>
      ...
      <Text>
        ...
        itself won&#39;t have any effect since the build is just executed once.
        If you want to play with the framework and see the consequences of your
...
export default PageExampleProject;

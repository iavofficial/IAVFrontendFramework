...
const PageFaq: React.FC = () => {
  return (
    <Page>
      ...
      <Text>
        Use the following steps to solve issues regarding the SVG import as
        React Components:
      </Text>
      <Text>
        Install the vite-plugin-svgr with the command "npm i vite-plugin-svgr"
        and configure it as shown{" "}
        <PageLink
          label={"here"}
          to={"https://www.npmjs.com/package/vite-plugin-svgr"}
        />
        . If this doesn’t help, further possible solutions can be found{" "}
        <PageLink
          to={

...
import { Column } from "../../../common/page/text/module/moduleTableColumns.tsx";
  ...
  return (
    <Page>
      ...
      <Text>
        ...
        authentication, internationalization, customizable themes, and the
        ability to integrate different corporate designs. By leveraging GitHub
        for version control and collaboration, developers benefit from
        streamlined workflows, centralized support, and reduced redundancy
        across projects.
      </Text>
      <Text>
        This is the official documentation of the IAV frontend framework. The
        job of the framework is to make your life way <strong>easier</strong>.
        It achieves maintainability, extendability, a lower risk of faults, and
        a greater developer experience by generalization. You want to maximize
        the speed of your development process? Just have a look.
      </Text>
      ...
      />
      <SubTitle>Ongoing Maintenance and Support</SubTitle>
      <Text>
        ...
        <PageLink
          to={
            "https://github.com/iavofficial/IAVFrontendFramework/blob/main/CONTRIBUTING.md"
          }

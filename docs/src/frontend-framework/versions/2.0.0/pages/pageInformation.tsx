  ...
  return (
    <Page>
      ...
      <Text>
        ...
        example for such a module is the AWSAuthenticator. Over time different
        sub systems, for example the routing mechanism, will be turned into
        modules. The Framework provides default modules while you are able to
        implement custom ones. Read more about this in a following chapter.
      </Text>
      ...
      <FigmaEmbed
        src={
          "https://www.figma.com/embed?embed_host=figma&url=https://www.figma.com/design/wHOYRy2ljmUpIwqO5FyRyl/IAV-Frontend-Framework?node-id=0-1&t=ThUTlCUH0Zl2S39C-1"
        }
      />
    </Page>
  );

function getConfig() {
    let apiRoot = "https://tj25ai6jb4.execute-api.eu-central-1.amazonaws.com/stage/";
    let domain = "localhost";
    let cognitoPoolId = "eu-central-1_7q9A8JsEq";
    let cognitoAppClientId = "5isuven114vtp9bb79u5i1tbo2";

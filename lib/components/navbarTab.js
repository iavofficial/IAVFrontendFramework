...
const NavbarTab = props => {
  ...
  const tab = /*#__PURE__*/React.createElement("div", {
    style: {
      borderStyle: "solid",
    ...
    src: props.active && !props.disabled ? props.selectedIcon : props.deselectedIcon,
    style: {
      marginLeft: "5%"
    },
    alt: ""
  ...
  return props.disabled ? tab : /*#__PURE__*/React.createElement(Link, {
    style: {
      textDecoration: "none"
    },
    to: props.to

...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  document.close();
  document.getElementById("header-container").innerHTML = await fetchData(
    `${basePath}/${newestVersion}/pages/html/header.html`,
  );
  document.getElementById("footer-container").innerHTML = await fetchData(
    `${basePath}/${newestVersion}/pages/html/imprint-footer.html`,
  );
  document.getElementById("nav-placeholder").innerHTML = await fetchData(
    `${basePath}/${newestVersion}/pages/html/nav.html`,
  );

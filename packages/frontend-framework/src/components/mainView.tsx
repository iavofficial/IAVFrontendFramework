...
export const MainView = (props: MainViewProps) => {
    ...
    const contentAreaBackground = colorSettingsContext.currentColors.contentArea.backgroundColor;
    ...
    return (
        ...
        >
            ...
            <div style={{display: "flex", flex: "1 1 auto", overflow: "auto", background: contentAreaBackground}}>

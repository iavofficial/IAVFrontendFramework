 ...
 *  */
export type TypedSelectorHook<S extends GeneralFunction> = TypedUseSelectorHook<RootState<S>>;

/** Use this hook for correct typing with redux dispatches. */
export type TypedDispatchHook<S extends GeneralFunction> =
ThunkDispatch<ReturnType<S>, unknown, Action<string>>;
...
const companyLogoDefault = (props: Props) => (
    <img src={ CompanyLogo } alt="Company Logo" style={{ display: (props.headerOptions?.hideRight ? "none" : "flex" ), height: "25px", marginRight: "12px" }}/>
);

const appLogoDefault = (props: Props)=> (
    <div style={{ display: (props.headerOptions?.hideLeft ? "none" : "flex"), alignItems: "center", height: "75px" }}>
          <img id="iav-logo" src={AppLogo} alt="DISA Logo" style={{ height: "40px", width: "125px", marginLeft: "12px", marginRight: "16px", backgroundColor: BLUE0 }} /> 
...
export const DisaHeader = (props: Props) => (
    <div id="disa-header" className={"p-d-flex p-jc-between p-align-center"} style={{ backgroundColor: BLUE0 }}>
        <div id="left-element" className={"p-d-flex p-align-center"} style={{ color: "white"}}>

...
import { DARK_AUTH_COMPANY_TEXT_COLOR, DARK_AUTH_FULL_SCREEN_BACKGROUND_COLOR, DARK_AUTH_HEADER_BACKGROUND_COLOR, DARK_AUTH_INPUT_FIELD_BACKGROUND_COLOR, DARK_AUTH_INPUT_FIELD_DESCRIPTION_COLOR, DARK_AUTH_INPUT_FIELD_TEXT_COLOR, DARK_AUTH_LEGAL_NOTICE_ICON_COLOR, DARK_AUTH_LOGIN_BUTTON_BACKGROUND_COLOR, DARK_AUTH_LOGIN_BUTTON_TEXT_COLOR, DARK_AUTH_LOGIN_FORM_BACKGROUND_COLOR, DARK_AUTH_PW_REQUIREMENTS_COLOR, DARK_AUTH_THEME_TOGGLER_COLOR, LIGHT_AUTH_COMPANY_TEXT_COLOR, LIGHT_AUTH_FULL_SCREEN_BACKGROUND_COLOR, LIGHT_AUTH_HEADER_BACKGROUND_COLOR, LIGHT_AUTH_INPUT_FIELD_BACKGROUND_COLOR, LIGHT_AUTH_INPUT_FIELD_DESCRIPTION_COLOR, LIGHT_AUTH_INPUT_FIELD_TEXT_COLOR, LIGHT_AUTH_LEGAL_NOTICE_ICON_COLOR, LIGHT_AUTH_LOGIN_BUTTON_BACKGROUND_COLOR, LIGHT_AUTH_LOGIN_BUTTON_TEXT_COLOR, LIGHT_AUTH_LOGIN_FORM_BACKGROUND_COLOR, LIGHT_AUTH_PW_REQUIREMENTS_COLOR, LIGHT_AUTH_THEME_TOGGLER_COLOR } from "../defaultColors";
